...
<div class="view-product-box">
    ...
    <form action="" method="post">
        ...
        <table width=100%>
            ...
            <?php
               // $all_user = mysqli_query($con, "select * from user order by user_id DESC")
...
if (isset($_GET['delete_user'])) {
    $delete_user = mysqli_query($con, "delete from user where user_id = '$_GET[delete_user]' ");
...
if (isset($_POST['deleteAll'])) {
    ...
    foreach ($remove as $key) {
        $run_remove = mysqli_query($con, "delete from user where user_id='$key'");
